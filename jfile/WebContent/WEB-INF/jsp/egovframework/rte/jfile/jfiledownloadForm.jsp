			...
			<div class="content_right">
				<table id="fileAreaTable"  width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;" class="board_view2">
					...
					<tr>
						...
						<th class="top" style="background-image: url('${ctx}/resources/swfupload/images/text-bg.gif');background-repeat: repeat-x;">다운로드 수</th>
						<th class="topend" style="background-image: url('${ctx}/resources/swfupload/images/text-bg.gif');background-repeat: repeat-x;">다운로드</th>
					</tr>
					<tr id="noDataRow">
