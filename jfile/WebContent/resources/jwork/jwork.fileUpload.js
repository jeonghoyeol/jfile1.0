...
jwork.fileUpload.prototype.initProperties = function() {
	...
	// swfLoader 관련
	this.flashUrl = this.ctx + "/resources/swfupload/swfupload/swfupload.swf";
	this.flash9Url = this.ctx + "/resources/swfupload/swfupload/swfupload_fp9.swf"
	...
	this.debug = false;
	this.buttonImageUrl = this.ctx + "/resources/swfupload/images/btn_file_search2.png";
	this.buttonWidth = 92,
...
jwork.fileUpload.prototype.appendFileRow = function(file, isSaved) {
	...
	var imgButton = jQuery("<img id='deleteButton_"+file.id+"' src='"+this.ctx+"/resources/swfupload/images/cancel.png' style='cursor: pointer;' />");
...
jwork.fileUpload.prototype.getBtnDownload = function(file) {
	...
	return jQuery("<img src=" + this.ctx + "/resources/swfupload/images/arrow_bg_no1.png />").bind("click", 
				function() {
			...
			setTimeout(	
				function() {	
					if(isOver && file.isSaved) {
						...
						fileupload.changePreviewByUrl(fileupload.ctx + "/resources/swfupload/images/no_img.gif");		
					}
				},
