package egovframework.com.jfile.security.service;
...
import egovframework.com.jfile.security.JCrypto;
...
public class CipherServiceImpl implements CipherService {
	...
	public byte[] decrypt(byte[] data) throws InvalidKeyException,
		...
		if (jcrypto.isApplyBase64()) {
			...
			byte[] temp = new sun.misc.BASE64Decoder().decodeBuffer(new String(
					data));
			bData = temp;
		} else {
			bData = data;
