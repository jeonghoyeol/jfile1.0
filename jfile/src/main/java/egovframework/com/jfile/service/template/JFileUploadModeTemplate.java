...
import egovframework.com.jfile.service.FileUploadCompletedEventListener;
import egovframework.com.jfile.service.JFile;
import egovframework.com.jfile.service.JFileDetails;
import egovframework.com.jfile.service.strategy.JFileUploadTypeFactory;
import egovframework.com.jfile.utils.KeyHelper;
...
//		jfile.setUseSecurity(fileVo.getUseSecurity());
	...
	public void upload(MultipartFile multipartFile, JFileDetails fileVo) {
		...
		fileVo.setFileMask(getFileMask(multipartFile.getOriginalFilename(), 0, fileVo.getUploadMode(), JProperties.getString(GlovalVariables.DEFAULT_FILE_UPLOAD_PATH_KEY)));
